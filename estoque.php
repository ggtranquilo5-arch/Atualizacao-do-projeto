...
<div class="main">
    ...
    <div class="cards">
        <div class="card">
            ...
            <i class="fa fa-exchange-alt card-icon" style="color: #3b82f6;"></i>
        </div>
        <div class="card">
            <div class="card-info">
                <h3>Entradas</h3>
            ...
            <i class="fa fa-arrow-down card-icon" style="color: #10b981;"></i>
        </div>
        <div class="card">
            <div class="card-info">
                <h3>Saídas</h3>
            ...
            <i class="fa fa-arrow-up card-icon" style="color: #ef4444;"></i>
        </div>
    </div>
